...
func TestCreateCategorySuccess(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodPost, "http://localhost:3333/api/categories", requestBody)
...
func TestUpdateCategorySuccess(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodPut, "http://localhost:3333/api/categories/"+strconv.Itoa(category.Id), requestBody)
	request.Header.Add("Content-Type", "application/json")
	request.Header.Add("X-API-KEY", "SECRET")
...
func TestGetCategorySuccess(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodGet, "http://localhost:3333/api/categories/"+strconv.Itoa(category.Id), nil)
	request.Header.Add("X-API-KEY", "SECRET")
...
func TestGetCategoryFailed(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodGet, "http://localhost:3333/api/categories/404", nil)
	request.Header.Add("X-API-KEY", "SECRET")
...
func TestDeleteCategorySuccess(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodDelete, "http://localhost:3333/api/categories/"+strconv.Itoa(category.Id), nil)
	request.Header.Add("Content-Type", "application/json")
	request.Header.Add("X-API-KEY", "SECRET")
...
func TestDeleteCategoryFailed(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodDelete, "http://localhost:3333/api/categories/404", nil)
	request.Header.Add("Content-Type", "application/json")
	request.Header.Add("X-API-KEY", "SECRET")
...
func TestListCategoriesSuccess(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodGet, "http://localhost:3333/api/categories", nil)
	request.Header.Add("X-API-KEY", "SECRET")
